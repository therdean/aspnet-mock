        ...
        stage('Backup') {
            steps {
                script {
                    ...
                    bat "mkdir ${backupDir}"
                    bat "robocopy C:\\Users\\Dejan.Ristevski\\Desktop\\aspnet_app\\publish ${backupDir} /e"
                }
            }
        }
    }
...
// robocopy C:\\Users\\Dejan.Ristevski\\Desktop\\aspnet_app\\publish ${backupDir} /E /S /COPYALL
